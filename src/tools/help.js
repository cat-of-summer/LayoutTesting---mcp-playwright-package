  ...
  server.registerTool(
    'help',
    {
      ...
      inputSchema: {
        ...
        brief: z.boolean().optional().describe(d('С guide: только чек-лист и гейт фазы')),
      },
